...
public interface RentRepository extends JpaRepository<Rent,Long> {
    ...
    @Query("SELECT r FROM Rent r WHERE r.user_id.id= (:username) AND NOT r.finished= true   ORDER BY r.date_from desc")
    public List<Rent> getRentsByUserNameNotFinishedOrderByDate(@Param("username") String username);
