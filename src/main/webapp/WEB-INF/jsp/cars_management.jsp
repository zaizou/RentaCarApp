...
<section id="main">
    ...
    <section id="content">
        <div class="container">
            ...
            <c:import url="cars_pages/list_cars.jsp">
            <c:param name="listCars" value="${listCars}"/>
        </c:import>

            <c:import url="cars_pages/car_create.jsp">
            </c:import>
...
<script type="text/javascript" src="js/functions_cars_management.js"></script>
