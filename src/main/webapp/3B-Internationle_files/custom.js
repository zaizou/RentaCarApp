...
/*------------------------------------------------------------------------*/
    ...
    $(".responsive-menu .menu .sousMenu a").click(function(){ 
        $('.responsive-menu .menu').hide();
        //$('.left-header').hide();
    });
	
	$(".responsive-menu .menu .menuToHide a").click(function(){
        $('.responsive-menu .menu').hide();
    });

	/*$(".responsive-menu .menu .batata a").click(function(){ 
        document.getElementById('bigMenu').style.visibility="hidden";
		document.getElementById('smallMenu1').style.visibility="visible";
    });*/
